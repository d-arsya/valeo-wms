...
import { FileSpreadsheet, Plus, Upload, Warehouse } from 'lucide-react';
import { useCallback, useState } from 'react';
import type { FormEvent } from 'react';
import { SparepartsExportDialog } from '@/components/features/spareparts/spareparts-export-dialog';
import { SparepartsImportDialog } from '@/components/features/spareparts/spareparts-import-dialog';
                        ...
                        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                            ...
                            {isAdmin && (
                                <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
                                    ...
                                    >
                                        <Upload className="size-4 shrink-0 text-blue-600" />
                                        Import Excel
                                    </Button>
                                    <Button
                                        type="button"
            ...
            {isAdmin && (
                <>
                    <FloatingActionButton
                        ...
                        label="Add sparepart"
                    />
                    <SparepartsExportDialog
                        open={isExportDialogOpen}
                        onOpenChange={setIsExportDialogOpen}
                    />
                    <SparepartsImportDialog
