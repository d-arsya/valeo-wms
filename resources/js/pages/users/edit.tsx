                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card className="gap-0 overflow-hidden border-border/60 shadow-sm">
                        <CardHeader className="border-b border-border/60">
                            ...
                            <CardDescription>Update user details or change their system role.</CardDescription>
                        </CardHeader>
                        ...
                        <CardContent className="flex flex-col gap-3 border-t border-border/60 py-4 sm:flex-row sm:items-center sm:justify-between">
                            <p className="text-xs text-muted-foreground">Changing the role will instantly alter user permissions.</p>
...
Edit.layout = {
    breadcrumbs: [
        ...
        {
            title: 'Edit User',
            href: users.edit(0), // Placeholder index
        },
    ],
};
